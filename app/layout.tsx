...
export const metadata: Metadata = {
  ...
  title: {
    default: "EINCODE — Nitish Kumar's Digital Laboratory",
    template: "%s | EINCODE",
  },
  description:
    "A digital workshop where code meets curiosity. Experiments, prototypes, and open-source artifacts by Nitish Kumar.",
  ...
  authors: [{ name: "Nitish Kumar", url: "https://github.com/leonitish7" }],
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: "/",
    title: "EINCODE — Nitish Kumar's Digital Laboratory",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "EINCODE — Nitish Kumar's Digital Laboratory",
      },
    ],
  },
  twitter: {
